...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Users/Hugo/Sites/Hangman/app/cache/dev/annotations', true);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_f0b3616ecee3110be9dd1197a4bc155a');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_f0b3616ecee3110be9dd1197a4bc155a');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_f0b3616ecee3110be9dd1197a4bc155a');
        ...
        $d->setProxyDir('/Users/Hugo/Sites/Hangman/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        $a = new \Game\Bundle\HangmanBundle\WordList(array(0 => '/Users/Hugo/Sites/Hangman/app/data/words.txt', 1 => '/Users/Hugo/Sites/Hangman/app/data/words.xml'));
        $a->loadDictionaries();

        return $this->services['hangman.game_context'] = new \Game\Bundle\HangmanBundle\GameContext($this->get('session.storage'), $a);
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Users/Hugo/Sites/Hangman/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\SqliteProfilerStorage('sqlite:/Users/Hugo/Sites/Hangman/app/cache/dev/profiler.db', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Users/Hugo/Sites/Hangman/app/config/routing_dev.yml', array('cache_dir' => '/Users/Hugo/Sites/Hangman/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appdevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appdevUrlMatcher'));
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/Users/Hugo/Sites/Hangman/app/cache/dev/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/Users/Hugo/Sites/Hangman/app/cache/dev/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Users/Hugo/Sites/Hangman/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Users/Hugo/Sites/Hangman/app/cache/dev');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Users/Hugo/Sites/Hangman/app/cache/dev',
            ...
            'debug.container.dump' => '/Users/Hugo/Sites/Hangman/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'profiler.storage.dsn' => 'sqlite:/Users/Hugo/Sites/Hangman/app/cache/dev/profiler.db',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Users/Hugo/Sites/Hangman/app/cache/dev/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/Users/Hugo/Sites/Hangman/app/cache/dev/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/Users/Hugo/Sites/Hangman/app/cache/dev/assetic',
            ...
            'hangman.word_list.class' => 'Game\\Bundle\\HangmanBundle\\WordList',
            'hangman.word_list.dictionaries' => array(
                0 => '/Users/Hugo/Sites/Hangman/app/data/words.txt',
                1 => '/Users/Hugo/Sites/Hangman/app/data/words.xml',
            ),
